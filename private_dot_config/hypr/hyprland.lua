...
hl.plugin.darkwindow.load_shader("chromakeyCatppuccin", {
  from = "chromakey",
  args = "bkg=[0.0235 0.1529 0.2275] similarity=0.25",
  fade_in_speed = 2, -- value in ds
  fade_out_speed = 2,
})
...
hl.window_rule({
  ...
  match = {
    class =
    "^(obsidian|code|com.github.th-ch.youtube-music|org.freedesktop.impl.portal.desktop.kde|org.kde.dolphin|org.kde.filelight|com.github.hluk.copyq|dev.zed.Zed|vicinae|emote|org.kde.gwenview|vesktop|slack)$",
  },
